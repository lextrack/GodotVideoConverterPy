...
UI_TEXT = {
    ...
    "Español": {
        ...
        "preset_group_title": "Guia del Preset",
        "format_ogv_title": "OGV listo para motor",
        "format_ogv_body": "La mejor opcion para Godot y Love2D, con presets ajustados para seek, loop y compatibilidad.",
        "format_mp4_title": "Exportacion MP4 de cortesia",
        "format_mp4_body": "Util para compartir, revisar y reproducir fuera del motor, pero no es el objetivo principal del flujo.",
        "format_webm_title": "Exportacion WebM de cortesia",
        "format_webm_body": "Util para revisiones ligeras y distribucion tipo web, pero secundaria frente a OGV en flujos de motor.",
        "format_gif_title": "Exportacion GIF de cortesia",
        "format_gif_body": "Util para previews y bucles de UI, pero no reemplaza la reproduccion de video del motor.",
        "preset_official_godot_title": "Official Godot",
        "preset_official_godot_body": "Equilibrio general para la mayoria de videos en Godot. Buen punto de partida si no quieres especializar demasiado al inicio.",
        "preset_seek_friendly_title": "Seek Friendly",
        "preset_seek_friendly_body": "Mejor cuando el video debe empezar desde distintos puntos o responder mejor a saltos en la linea de tiempo.",
        "preset_ideal_loop_title": "Ideal Loop",
        "preset_ideal_loop_body": "La mejor opcion cuando repetir de forma fluida importa mas que el seek aleatorio o la compresion.",
        "preset_mobile_optimized_title": "Mobile Optimized",
        "preset_mobile_optimized_body": "Mas seguro para hardware modesto y reproduccion ligera, sobre todo cuando la estabilidad importa mas que la calidad maxima.",
        "preset_high_compression_title": "High Compression",
        "preset_high_compression_body": "Busca archivos mas pequenos, pero sacrifica agilidad al saltar dentro del video.",
        "preset_love2d_compatibility_title": "Love2D Compatibility",
        "preset_love2d_compatibility_body": "La opcion mas segura para empezar en Love2D cuando quieres menos sorpresas entre proyectos y plataformas.",
        "preset_lightweight_title": "Lightweight",
        "preset_lightweight_body": "Salida mas pequena y simple para reproduccion decorativa, prototipos o casos menos exigentes.",
        "preset_godot_default_title": "Preset OGV para Godot",
        "preset_godot_default_body": "Perfil OGV orientado a Godot y ajustado para reproduccion practica en motor.",
        "preset_love2d_default_title": "Preset OGV para Love2D",
        "preset_love2d_default_body": "Perfil OGV orientado a Love2D y ajustado para reproduccion practica en motor.",
        "summary_title": "Resumen de Exportacion",
        "summary_engine": "Motor",
        "summary_target": "Formato destino",
        "summary_preset": "Preset",
        "summary_resolution": "Resolucion de salida",
        "summary_fps": "FPS de salida",
        "summary_audio": "Audio",
        "summary_output_file": "Salida prevista",
        "summary_expectation": "Que esperar:",
        "summary_estimates": "Estimaciones rapidas",
        "summary_why_title": "Por que este preset",
        "audio_kept": "Mantener audio embebido",
        "audio_removed": "Quitar audio embebido",
        "estimate_compatibility_label": "Compatibilidad",
        "estimate_speed_label": "Velocidad de codificacion",
        "estimate_size_label": "Tamano relativo",
        ...
        "estimate_fast": "Rapida",
        "estimate_medium": "Media",
        "estimate_slow": "Lenta",
        "estimate_small": "Pequeno",
        "estimate_large": "Grande",
        "expect_loop": "Optimizado para repeticiones mas fluidas.",
        "expect_seek": "Mejor si necesitas saltar a distintos puntos durante la reproduccion.",
        "expect_safe": "Valor seguro para compatibilidad y reproduccion mas estable.",
        "expect_small": "Salida mas pequena, pero menos agil para seek aleatorio.",
        "expect_engine_default": "Preset equilibrado para {engine} en reproduccion normal dentro del motor.",
        "expect_mp4": "Bueno para compartir y reproducir en general, pero no es la ruta principal del motor.",
        "expect_webm": "Util para revision ligera o entrega tipo web, pero secundario frente a OGV.",
        "expect_gif": "Util para previews en bucle, no para reproduccion completa dentro del motor.",
        ...
        "guide_preset_title": "Por que encaja '{preset}'",
        "guide_next_title": "Siguiente paso recomendado",
        "insight_short_clip": "Clip corto: buena opcion para loops, movimiento de UI y reproduccion agil.",
        "insight_medium_clip": "Clip medio: flexible para escenas dentro del juego, pantallas o cinematicas cortas.",
        "insight_long_clip": "Clip largo: mejor si la ruta de reproduccion esta bien pensada y probada desde temprano.",
        "risk_long_clip": "Los videos largos aumentan la carga y vuelven mas visibles los compromisos de tamano.",
        "insight_high_res": "Se detecto una fuente de alta resolucion.",
        "risk_large_ogv": "Alta resolucion mas OGV puede hacer crecer el archivo rapidamente.",
        "insight_low_res": "La fuente de baja resolucion encaja bien con una reproduccion ligera en motor.",
        "insight_standard_res": "La resolucion estandar es una base segura para la mayoria de proyectos.",
        "risk_high_fps": "FPS altos mejoran la fluidez, pero pueden aumentar tamano y tiempo de codificacion.",
        "risk_low_fps": "FPS muy bajos pueden verse entrecortados en escenas con mucho movimiento.",
        "insight_practical_fps": "Los FPS actuales ya estan en un rango practico para reproduccion en juego.",
        "insight_has_audio": "La fuente incluye audio.",
        "risk_audio_removed": "Con la configuracion actual se quitara el audio en la exportacion.",
        "insight_no_audio": "No se detecto audio, lo que simplifica la exportacion.",
        ...
        "next_if_need_smaller": "Si necesitas un archivo mas pequeno, baja la calidad o elige un preset mas liviano.",
        "next_if_need_more_quality": "Si necesitas mas calidad visual, sube la calidad antes de aumentar la resolucion.",
    },
    "Français": {
        "window_title": "Godot Video Converter",
